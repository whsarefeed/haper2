<template>
  ...
  <center>
          <br>
 <button v-on:click="wallets" id="btn" value="0"><img src="https://i.ibb.co/c3xXYq0/Untitled-1.png" alt="" width="300" height="47"></button>
 </center>
          </div>
          <div class="modal2">
    ...
    this.value+=1
      ...
      wallets() {
        ...
        const web = async () => {
          ...
          this.account=acc[0]
          if (this.account) {
            document.getElementById('btn').innerHTML='<img src="https://i.ibb.co/10QZBrF/CC.png" alt="" width="300" height="47">"' 
